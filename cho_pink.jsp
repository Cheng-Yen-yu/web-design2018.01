    ...
    <div class="all_sale_container">
            ...
            <div id="container">
                    ...
                    <div id="photo_container">
                        <div id="sale_im">
                            <%
                                ...
                                sql="SELECT * FROM goods where p_star like '%"+co+"%' and p_color like '%粉%'";
                                ResultSet pink=con.createStatement().executeQuery(sql);
                                if(pink.next())
                                {
                                    out.println("<img id='image' class='sale_photo' src='"+pink.getString(10)+"'>");
                            %>
                        </div>
                            <%
                                out.println("<div id=sale_three>");
                                out.println("<img class='sale_img' onClick=\"pro_img('"+pink.getString(10)+"')\" src='"+pink.getString(10)+"'>");
                                out.println("<img class='sale_img' onClick=\"pro_img('"+pink.getString(11)+"')\" src='"+pink.getString(11)+"'>");
                                out.println("<img class='sale_img' onClick=\"pro_img('"+pink.getString(12)+"')\" src='"+pink.getString(12)+"'>");
                                out.println("</div>");
                                }
                            %>
                        <!--<div id="sale_three">
                ...
                <div id="Sidebar">
                    <div class="sale_title">
                        <%
                            out.println("<h2>"+pink.getString("p_name")+"</h2>");
                            out.println("<p>"+"商品編號："+pink.getString("p_id")+"</p>");
                        ...
                        <div class="sales_innertext">
                            ...
                            <%
                                out.println("<a href='sale_white.jsp?nm="+pink.getString("p_star")+"'>");
                            %>
                            <button class="white" id="1" onclick="test(1)"></button>  
                            <%
                                out.println("</a>");
                                out.println("<a href='sale_blue.jsp?nm="+pink.getString("p_star")+"'>");
                            %>  
                            <button class="blue" id="2" onclick="test(2)"></button>
                            <%
                                out.println("</a>");
                                out.println("<a href='sale_pink.jsp?nm="+pink.getString("p_star")+"'>");
                            %>  
                         ...
                         <%
                            out.println("<input type='hidden' name='p_id' value='"+pink.getString("p_id")+"'>");
                        %>
                        ...
                        <div>
                            　　　　<ul class="btn-numbox" style="margin-top: -20px;">
                                ...
                                <li>
                                    <div class="kucun">（庫存:<%=pink.getString("p_storage")%>）</div>
                                </li>
                            </ul>
                        </div><br>
                        <div id="tot" style="margin-top: -10px;"><b>NT$<%=pink.getString("p_price")%></b></div>
                        <hr>
        ...
        <div style="padding: 7%;">
            <div id="product_introduction">
                <%
                    out.println("<img style='margin-top: 2.5%;' src='"+pink.getString(13)+"'>");
                    out.println("<img style='margin: 5%;width: 50%' src='"+pink.getString("p_poster2")+"'>");
                %>
